        ...
        <div class="row">
            ...
            <div class="float-right margin-tb " style="margin-bottom: 10px;">
                ...
                <div class="pull-right">
                    ...
                    <a class="btn btn-success" href="classroom/add"> Add New Class</a>
                </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{url('/classroom/delete', $kelas->id)}}" method="post">
                            <a href="{{url('classroom/detail',$kelas->id)}}" class="btn btn-info">Show</a>
                            <a href="{{url('classroom/edit',$kelas->id)}}" class="btn btn-primary">Edit</a>
                            @csrf
                            @method('DELETE')
